...
public class SpikeTrap : Trap
{
    ...
    void Update()
    {
        ...
        if ((int)Time.time % interval == 0)
        {
            ...
            a.Play("SpikeTrapActive");
        }
        else
        {
            a.Play("SpikeTrapIdle");
            playerHit = false;
        }
    ...
    void OnTriggerStay2D(Collider2D other)
    {
        ...
        {
            //Debug.Log("Player is playerHit by a spike trap: " + other.gameObject.name.ToString());
            playerHit = true;
        ...
        {
            Debug.Log("Spike trap destroys: " + other.gameObject.name.ToString());
