...
public abstract class ANeuron {
    ...
    public ANeuron(int numberOfInputs, Function<Float, Float> activationFunction) {
    ...
    public ANeuron(float[] weights, Function<Float, Float> activationFunction) {
