...
public class SudokuBoardIllegalAccessException extends SudokuBoardException {
    /**
     ...
     */
    public SudokuBoardIllegalAccessException(String message) {
        super(message);
    }
     ...
     */
    public SudokuBoardIllegalAccessException(String message, Throwable cause) {
        super(message, cause);
    }

    public SudokuBoardIllegalAccessException(Throwable cause) {
        super(cause);
    }
}
