...
/**
 * Klasa będąca pod klasą SudokuBoardException w hierarchi wyjątków w modelu.
 * @author Łukasz Gapiński 242386
 * @author Mateusz Gapiński 242387
 */
public class SudokuBoardAutoverificationNotPassedException extends SudokuBoardException {
     ...
     */
    public SudokuBoardAutoverificationNotPassedException(String message) {
        super(message);
    }
     ...
     */
    public SudokuBoardAutoverificationNotPassedException(String message, Throwable cause) {
        super(message, cause);
    }
}
