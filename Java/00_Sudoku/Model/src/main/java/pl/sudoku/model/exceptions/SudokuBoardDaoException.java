...
public class SudokuBoardDaoException extends SudokuBoardException {
    /**
     ...
     */
    public SudokuBoardDaoException(String message) {
        super(message);
    }
     ...
     * @param cause   Określa przyczynę rzucanego wyjątku, którą jest inny wyjątek.
     */
    public SudokuBoardDaoException(Throwable cause) {
        super(cause);
    }
}
