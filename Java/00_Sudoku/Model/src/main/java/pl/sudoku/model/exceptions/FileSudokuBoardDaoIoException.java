 ...
 */
public class FileSudokuBoardDaoIoException extends SudokuBoardDaoException {
     ...
     */
    public FileSudokuBoardDaoIoException(String message) {
        super(message);
    }
     ...
     */
    public FileSudokuBoardDaoIoException(String message, Throwable cause) {
        super(message, cause);
    }
}
