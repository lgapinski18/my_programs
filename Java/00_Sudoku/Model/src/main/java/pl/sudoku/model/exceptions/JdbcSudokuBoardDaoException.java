...
public class JdbcSudokuBoardDaoException extends SudokuBoardDaoException {
    /**
     ...
     */
    public JdbcSudokuBoardDaoException(String message) {
        super(message);
    }
     ...
     * @param cause Określa przyczynę rzucanego wyjątku, którą jest inny wyjątek.
     */
    public JdbcSudokuBoardDaoException(Throwable cause) {
        super(cause);
    }
}
