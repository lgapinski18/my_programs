 ...
 */
public class SudokuBoardElementException extends SudokuBoardException {
     ...
     */
    public SudokuBoardElementException(String message) {
        super(message);
    }
     ...
     */
    public SudokuBoardElementException(String message, Throwable cause) {
        super(message, cause);
    }
}
