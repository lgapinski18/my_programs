...
/**
 * Klasa będąca podklasą SudokuException w hierarchi wyjątków w modelu.
 * @author Łukasz Gapiński 242386
 * @author Mateusz Gapiński 242387
 */
public class SudokuClassNotFoundException extends SudokuException {
    /**
     ...
     */
    public SudokuClassNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }
}
