...
public class SudokuBoardInstantionException extends SudokuBoardException {
    /**
     ...
     */
    public SudokuBoardInstantionException(String message) {
        super(message);
    }
     ...
     */
    public SudokuBoardInstantionException(String message, Throwable cause) {
        super(message, cause);
    }

    public SudokuBoardInstantionException(Throwable cause) {
        super(cause);
    }
}
